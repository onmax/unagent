...
```ts
import { bold, red, formatList, shortenPath } from 'unagents/utils'
```
...
```ts
import { bold, dim, red, green, yellow, blue, cyan, gray } from 'unagents/utils'
...
```ts
import { bold, green, red, formatList, pluralize, shortenPath } from 'unagents/utils'
